...
x = String('Цой - Дерево', 'x')
a = String('Я знаю, мое дерево не проживет и недели.', 'a')
b = Number(1, 'b')
b.add_edge(a)
c = String('Я знаю, мое дерево в этом городе обречено.', 'c')
d = Number(2, 'd')
d.add_edge(c)
e = String('Но я все свое время провожу рядом с ним:', 'e')
f = Number(3, 'f')
f.add_edge(e)
g = String('Мне все другие дела надоели...', 'g')
h = Number(4, 'h')
h.add_edge(g)
